...
- CORI opinionated version at Census Block level is also now using that
  version.
...
- Use CORI-brewed `download_file` function; global user_agent no longer
  needed
...
- Add NBM Block: CORI opinionated version designed at the Census block
  level
...
- [`get_frn_nbm_bl()`](https://ruralinnovation.github.io/cori.data.fcc/reference/get_frn_nbm_bl.md)
  allows you to get all block where this FRN reported had services
  (minus satellite BSL and 0/0 speeds services)
...
- update to `get_fcc_dictionary.R` description for new data set
  (“nbm_block”, “nbm_raw”) and their fields
