...
See [**Democratizing analytics on FCC’s (big)
data**](https://ruralinnovation.github.io/blog/posts/12_fcc-data/) for
more info about the different ways we are using this data.
...
[Development
notes](https://ruralinnovation.github.io/cori.data.fcc/DEVELOPMENT.MD).
