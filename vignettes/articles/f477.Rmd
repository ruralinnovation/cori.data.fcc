...
FCC is asking for proper credit to be give: 
...
This is a complicated data set that have seen relative small change in its structure and can have multiple version per release. 


For our purpose it make sense to only care about *Fixed without satellite*. We also took the decision 